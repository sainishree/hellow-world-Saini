...
<h2> DevOps CI/CD pipeline using Maven,Java,Jenkins,Ansible,Docker,Gits </h2>
...
.custom {
   ...
   <body>
      <center>
<FONT SIZE="6" COLOR="#FF0000"> Below server's files are modified in last 5 minutes </FONT>
         <%
